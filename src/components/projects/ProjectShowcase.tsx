			...
			>
				<div className="md:grow md:basis-0">
					<span className="mb-2 inline-flex flex-col gap-2 xs:mb-0 xs:flex-row xs:flex-wrap xs:items-center xs:gap-4">
						<h2 className="text-3xl font-semibold xs:text-4xl">{name}</h2>
				...
				>
					<CarouselContent className="mb-2">
						{screenshots.map((screenshot) => (
							...
							>
								<button className="cursor-default" aria-roledescription="magnify image" onClick={() => setMagnifiedScreenshot(screenshot)}>
									<img
										loading="eager"
