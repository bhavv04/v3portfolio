	...
	return (
		<div className="flex min-h-screen w-full items-center justify-center">
			<div className="w-full font-mono">
				<div
					className="mx-auto flex h-[80vh] w-full max-w-2xl flex-col overflow-hidden rounded-xl border border-gray-700/50 bg-[rgba(13,13,13,0.6)] shadow-2xl backdrop-blur-2xl"
