...
- **Swipe interface** — drag cards left to pass, right to save, with animated LIKE/PASS indicators as you drag
- **Genre-based feed** — pick genres during onboarding, and the feed rotates through them automatically
...
- [ ] AI recommendations — Claude API generates a personalized "why you'd like this" blurb based on swipe history
...
Background photo by Peter Herrmann on Unsplash.