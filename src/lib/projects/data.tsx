...
export const projects: Project[] = [
	{
		name: "Bug Report App",
		summary: "Streamline bug tracking and resolution with our intuitive bug-report website. Effortlessly report and manage software issues for smoother development cycles.",
		technologies: [
			Technology.React,
			Technology.Python,
			Technology.Figma,
